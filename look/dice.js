...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-ce8ec27b');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-ce8ec27b');}
...
var brandEl=document.querySelector('.rl-brand-ce8ec27b');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
